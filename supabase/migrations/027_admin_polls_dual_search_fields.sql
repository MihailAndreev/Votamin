-- ============================================================
-- Migration 027: Admin polls dual search fields (title + author)
--
-- Purpose:
-- - Support separate title and author search inputs in admin polls UI
-- - Allow filtering by both fields at the same time
-- ============================================================
